...
| **Sprint Goal & User Stories**  |                                                                                                                                                                                                                                      |
| Sprint 1 Goal                   | Nuestro enfoque está en: implementar las funciones clave para gestionar registros y solicitudes en TransportApp, junto con la integración de un dispositivo IoT para monitorear en tiempo real la temperatura y el peso de los vehículos.
