...
| US-30             | Visualización de la información sobre el transporte                               | Como usuario de la aplicación.<br><br>Quiero poder recibir información del transporte.<br><br>Para poder tener constancia de la situación de producto transportado                                           | **Escenario 1: Acceso a la pantalla de datos**<br><br>**Dado que** el usuario se encuentra en la pantalla principal.<br>**Cuando** el usuario selecciona la opción de visualizar la información.<br>**Entonces** el usuario es enviado a una pantalla en dónde de visualiza en tiempo real la temperatura, peso, lugar de salida y llegada, horario estimado de salida y llegada.<br><br>Escenario 2: Datos no disponibles<br>Dado que el usuario se encuentra en la pantalla principal,<br>Cuando selecciona la opción de visualizar la información, pero el sistema no puede obtener los datos de los sensores debido a una interrupción en la conexión,<br>Entonces el sistema debe mostrar un mensaje indicando que los datos no están disponibles en ese momento.                                                                                                                                                                                                                                                                                                                                                                                                                                      | EP-05       |
...
| US-36             | Obtener datos de perfil                                                           | Como usuario, quiero obtener los datos de mi perfil desde el backend, para visualizar mi información personal actualizada.                                                                                   | **Escenario 1: Obtener datos de perfil exitosamente**<br><br>Dado que el endpoint `api/v1/profile` está disponible,<br>Cuando se realiza una solicitud GET con el token de autenticación válido,<br>Entonces se devuelve un recurso con los datos del perfil del usuario.<br><br>**Escenario 2: Error al obtener datos de perfil**<br><br>Dado que el token de autenticación es inválido o ha expirado,<br>Cuando se realiza una solicitud GET al endpoint `api/v1/profile`,<br>Entonces se devuelve un código de estado HTTP 401 (Unauthorized) con un mensaje de error apropiado.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | 2           |
| US-37             | Registro de usuario                                                               | Como usuario, quiero poder registrarme en la aplicación, para crear una cuenta y acceder a las funcionalidades del sistema                                                                                   | **Escenario 1: Registro exitoso**<br><br>Dado que el endpoint `api/v1/auth` está disponible,<br>Cuando se realiza una solicitud POST con un cuerpo válido (nombre, email, contraseña, etc.),<br>Entonces se crea un nuevo usuario y se devuelve un código de estado HTTP 201 (Created) con los datos básicos del usuario.<br><br>**Escenario 2: Error en el registro**<br><br>Dado que el email ya está registrado en el sistema,<br>Cuando se realiza una solicitud POST al endpoint `api/v1/auth,<br>Entonces se devuelve un código de estado HTTP 409 (Conflict) con un mensaje que indica que el correo ya está en uso.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 2           |
| US-38             | Dashboard                                                                         | Como usuario, quiero acceder a un dashboard en la aplicación móvil y web, para monitorear mis datos y estadísticas relevantes en tiempo real.                                                                | **Escenario 1: Acceso al dashboard**<br><br>Dado que el usuario está autenticado,<br>Cuando accede a la pantalla principal de la aplicación,<br>Entonces se muestra un dashboard con información en tiempo real sobre sus datos.<br><br>**Escenario 2: Error al cargar datos del dashboard**<br><br>Dado que el backend no responde o hay un problema de red,<br>Cuando se intenta cargar el dashboard,<br>Entonces se muestra un mensaje de error indicando que los datos no están disponibles temporalmente.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 5           |
| US-39             | Create request                                                                    | Como cliente, quiero crear una solicitud desde la aplicación móvil o web, para iniciar un proceso en el sistema                                                                                              | **Escenario 1: Solicitud creada exitosamente**<br><br>Dado que el usuario está autenticado y los campos del formulario están completos,<br>Cuando envía una solicitud desde la pantalla correspondiente,<br>Entonces se guarda la solicitud en el backend y se devuelve un mensaje de confirmación.<br><br>**Escenario 2: Error al crear la solicitud**<br><br>Dado que el usuario no ha completado todos los campos requeridos,<br>Cuando intenta enviar la solicitud,<br>Entonces se muestra un mensaje de error indicando qué campos faltan por completar.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | 5           |
| US-40             | See Request                                                                       | Como transportista, quiero visualizar las solicitudes que he creado en la aplicación móvil o web, para revisar su estado y detalles.                                                                         | **Escenario 1: Visualizar solicitudes exitosamente**<br><br>Dado que el usuario está autenticado,<br>Cuando accede a la sección de "Mis Solicitudes",<br>Entonces se muestra una lista con todas las solicitudes creadas junto con su estado (e.g., pendiente, en proceso, completada).<br><br>**Escenario 2: Error al cargar solicitudes**<br><br>Dado que el backend no responde o hay un problema de red,<br>Cuando se intenta cargar la sección de "Mis Solicitudes",<br>Entonces se muestra un mensaje de error indicando que no se pueden recuperar los datos en ese momento.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | 5           |
| US-41             | Configurar DHT22                                                                  | Como desarrollador, quiero configurar el sensor DHT22 para capturar datos de temperatura y humedad, para garantizar mediciones precisas en el sistema.                                                       | **Escenario 1: Configuración del sensor**<br><br>Dado que el DHT22 está conectado al ESP32,<br>Cuando se inicializa el sensor en el código,<br>Entonces se debe recibir una confirmación de que la configuración es exitosa.<br><br>**Escenario 2: Error en la configuración del sensor**<br><br>Dado que el sensor está desconectado o defectuoso,<br>Cuando se intenta inicializar el sensor,<br>Entonces se muestra un mensaje de error en el monitor serial indicando el problema.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 4           |
| US-42             | Configurar ESP32                                                                  | Como desarrollador, quiero configurar el ESP32 para establecer comunicación con el sensor y el backend, para recolectar y enviar datos correctamente.                                                        | **Escenario 1: Configuración exitosa del ESP32**<br><br>Dado que el ESP32 está conectado a una red Wi-Fi,<br>Cuando se carga el código al dispositivo,<br>Entonces debe establecerse conexión con el backend y el sensor.<br><br>**Escenario 2: Error en la configuración del ESP32**<br><br>Dado que los detalles de la red Wi-Fi son incorrectos,<br>Cuando se intenta conectar el ESP32,<br>Entonces se muestra un mensaje de error en el monitor serial indicando que no se puede conectar a la red.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | 4           |
| US-43             | Conectar Physical App con Backend                                                 | Como desarrollador, quiero conectar la aplicación física basada en ESP32 con el backend, para garantizar el flujo de datos desde el sensor hasta la base de datos.                                           | **Escenario 1: Conexión exitosa con el backend**<br><br>Dado que el ESP32 está configurado correctamente,<br>Cuando envía datos al endpoint del backend,<br>Entonces los datos se almacenan exitosamente y se devuelve una confirmación HTTP 200.<br><br>**Escenario 2: Error en la conexión con el backend**<br><br>Dado que el endpoint del backend está inaccesible,<br>Cuando el ESP32 intenta enviar datos,<br>Entonces se muestra un mensaje de error indicando que no se puede alcanzar el servidor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | 4           |
### EPICS
...
| 36      | US-36         | Obtener datos de perfil                                                           | Como usuario, quiero obtener datos de mi perfil desde el backend para poder visualizar mi información.                                                                                                       | 3                        |
| 37      | US-37         | Registro de usuario                                                               | Como usuario, quiero registrarme en el sistema para poder acceder a las funcionalidades de la aplicación.                                                                                                    | 3                        |
| 38      | US-38         | Dashboard                                                                         | Como usuario, quiero acceder a un dashboard que resuma la información relevante de mi cuenta y servicios.                                                                                                    | 5                        |
| 39      | US-39         | Create Request                                                                    | Como usuario, quiero crear una solicitud de transporte desde la aplicación móvil o web.                                                                                                                      | 5                        |
| 40      | US-40         | See Request                                                                       | Como desarrollador, quiero configurar el sensor DHT22 para recolectar datos de temperatura.                                                                                                                  | 3                        |
| 41      | US-41         | Configurar DHT22                                                                  | Como desarrollador, quiero configurar el ESP32 para gestionar la conexión y envío de datos al backend.                                                                                                       | 3                        |
| 42      | US-42         | Configurar ESP32                                                                  | Como desarrollador, quiero conectar la aplicación física al backend para enviar y recibir datos.                                                                                                             | 3                        |
| 43      | US-43         | Conectar Physical App con Backend                                                 | Como usuario, quiero visualizar las solicitudes creadas en la aplicación para revisar su estado.                                                                                                             | 5                        |
...
| US02       | Sección Beneficios                                  | TS02             | Implementación de la sección Beneficios                        | Desarrollo e implementación de la Sección Beneficios con estilos responsive                                           | 2                  | Edery Abanto     | Done                                             |
| US03       | Sección Planes                                      | TS03             | Implementación de la sección planes                            | Desarrollo e implementación de la Sección Planes con estilos responsive                                               | 4                  | Sebastian Castro | Done                                             |
| US04       | Sección Contacto                                    | TS04             | Implementación de la sección contacto                          | Desarrollo e implementación de la Sección Contacto con estilos responsive                                             | 3                  | Camila Conde     | Done                                             |
| US05       | Sección Testimonios                                 | TS05             | Implementación de la sección testimonios                       | Desarrollo e implementación de la Sección Testimonios con estilos responsive                                          | 2                  | Diego Portales   | Done                                             |
| US06       | Sección de Preguntas Frecuentes                     | TS06             | Implementación de la sección preguntas frecuentes              | Desarrollo e implementación de la Sección Preguntas Frecuentes con estilos responsive                                 | 4                  | Rodrigo Sabino   | Done                                             |
| US-30      | Visualización de la información sobre el transporte | TS07             | Implementar seccion de visualizacion del transporte solicitado | Desarrollo de la sección para visualizar temperatura, peso, ubicación, lugar y horario del transporte en tiempo real. | 4                  |                  | To-do                                            |
| US-27      | Solicitud de servicio de transporte                 | TS08             | Implementación de la sección de Solicitud de transporte        | Desarrollo de la funcionalidad para solicitar un servicio de transporte con validación de datos.                      | 4                  |                  | To-do                                            |
...
| Prepared By                     | Abanto Vicente, Edery Renzo                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Attendees (to planning meeting) | Abanto Vicente, Edery Renzo / Castro Soto, Sebastian Enrique / Conde Isla, Camila Alessandra / Portales Ortiz, Diego Alejandro / Sabino Ramírez, Rodrigo Alexander / Luis Isla                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Sprint 1 Review Summary         | En el Sprint anterior (Sprint 1), logramos completar la Landing Page de TransportApp y comenzamos el desarrollo de la aplicación web, realizando algunas entrevistas y documentando el proyecto. Sin embargo, debido a problemas de organización y gestión del tiempo, no logramos completar la funcionalidad de la aplicación web.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Sprint 1 Retrospective Summary  | Durante la retrospectiva, el equipo expresó que el tiempo no fue medido ni organizado adecuadamente, lo que resultó en dificultades para alcanzar todos los objetivos del Sprint. Aprendimos que es necesario mejorar la planificación de las tareas para optimizar el tiempo y cumplir con las entregas.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Sprint Goal & User Stories**  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
Esto se confirmará cuando: Las funcionalidades de registro, solicitud y monitoreo sean probadas de manera satisfactoria, y los datos recibidos del dispositivo IoT (temperatura y peso) sean correctamente integrados y validados dentro del sistema.

| Sprint 1 Velocity | Sum of Story Points |
| ----------------- | ------------------- |
| 25 Story Points   | 50 Story Points     |
...
| User Story |                                                        | Work-Item / Task |                                       |                                                                                                 |                    |                |                                                  |
| Id         | Title                                                  | Id               | Title                                 | Description                                                                                     | Estimation (Hours) | Assigned To    | Status (To-do / In-Process / To – Review / done) |
| US-01      | Sección About Us                                       | T01              | Sección About Us                      | Desarrollo e implementación de la sección About Us con estilos responsive                       | 3                  | Edery          | Done                                             |
| US-09      | Registrar vehículos                                    | T02              | Conexión User con Profile             | Conectar el modelo de usuario con el perfil correspondiente en el backend                       | 3                  | Sebastián      | Done                                             |
| US-09      | Registrar vehículos                                    | T03              | Get de profile con todos los valores  | Corregir el servicio Get de Profile para que devuelva todos los valores completos               | 2                  | Sebastián      | Done                                             |
| US-09      | Registrar vehículos                                    | T04              | Put de Profile                        | Implementar el servicio Put para permitir la edición del perfil del usuario                     | 4                  | Sebastián      | Done                                             |
| US-25      | Captura de Datos de Temperatura                        | T05              | Get para IotProcess                   | Crear un Get en IotProcess para que el sensor obtenga la información de temperatura ideal       | 3                  | Sebastián      | Done                                             |
| US-26      | Captura de Datos de Peso                               | T06              | Post de IotProcess con MAC Address    | Modificar el servicio Post de IotProcess para incluir el campo MAC Address del dispositivo      | 2                  | Sebastián      | Done                                             |
| US-33      | Notificar al conductor del transporte                  | T07              | Lógica de Alarmas                     | Implementar la lógica de alarmas para notificar sobre condiciones fuera de lo normal            | 5                  | Sebastián      | Done                                             |
| US-18      | Registro de transportista                              | T08              | Conectar Profile (Client y Carrier)   | Conectar la sección de perfil en el frontend con el backend.                                    | 3                  | Camila         | Done                                             |
| US-18      | Registro de transportista                              | T09              | Conectar Profile (Client y Carrier)   | Conectar la sección de perfil en la aplicación móvil con el backend                             | 2                  | Camila         | Done                                             |
| US-30      | Visualización de la información sobre el transporte    | T10              | Conectar Dashboard (Client y Carrier) | Conectar la sección de dashboard en el frontend con el backend.                                 | 4                  | Camila         | Done                                             |
| US-30      | Visualización de la información sobre el transporte    | T11              | Conectar Dashboard (Client y Carrier) | Conectar la sección de dashboard en la aplicación móvil con el backend.                         | 4                  | Camila         | Done                                             |
| US-28      | Historial                                              | T12              | Conectar History (Client y Carrier)   | Conectar el historial de cliente y transportista en el frontend con el backend                  | 3                  | Rodrigo        | Done                                             |
| US-28      | Historial                                              | T13              | Conectar History (Client y Carrier)   | Conectar el historial de cliente y transportista en el movil con el backend                     | 3                  | Rodrigo        | Done                                             |
| US-40      | See Request                                            | T14              | Conectar See Request                  | Conectar la funcionalidad de ver solicitud en el frontend con el backend                        | 3                  | Edery          | Done                                             |
| US-40      | See Request                                            | T15              | Conectar See Request                  | Conectar la funcionalidad de ver solicitud en el móvil con el backend                           | 3                  | Edery          | Done                                             |
| US-39      | Create Request                                         | T16              | Conectar Create Request               | Conectar la funcionalidad de crear solicitud en el frontend y móvil con el backend              | 3                  | Diego          | Done                                             |
| US-39      | Create Request                                         | T17              | Conectar Create Request               | Conectar la funcionalidad de crear solicitud en el frontend y móvil con el backend              | 3                  | Diego          | Done                                             |
| US-23      | Implementación de Edge Gateway con Backend Application | T18              | Corregir clases en Embedded App       | Revisar y corregir las clases en la aplicación embedded para mejorar la integración             | 3                  | Rodrigo        | Done                                             |
| US-23      | Implementación de Edge Gateway con Backend Application | T19              | Conectar Embedded App con Backend     | Establecer conexión entre la aplicación embedded y el backend                                   | 4                  | Rodrigo        | Done                                             |
| US-41      | Configurar DHT22                                       | T20              | Configurar DHT22                      | Configurar el sensor DHT22 y el módulo ESP32 para la aplicación física                          | 4                  | Luis           | Done                                             |
| US-43      | Conectar Physical App con Backend                      | T21              | Conectar Physical App con Backend     | Conectar la aplicación física que usa el ESP32 al backend para sincronización de datos          | 4                  | Luis           | Done                                             |
| US-41      | Configurar DHT22                                       | T22              | Adquirir productos                    | Adquirir los componentes necesario DHT22                                                        | 2                  | Luis           | Done                                             |
| US-42      | Configurar ESP32                                       | T23              | Adquirir productos                    | Adquirir los componentes necesario ESP32                                                        | 2                  | Luis           | Done                                             |
| US-01      | Sección About Us                                       | T24              | Añadir sección About the Product      | Crear una sección en la landing page para información sobre el producto con un video de YouTube | 3                  | Edery          | Done                                             |
| US-01      | Sección About Us                                       | T25              | Añadir sección About the Team         | Añadir una sección en la landing page sobre el equipo con un video de YouTube                   | 3                  | Diego          | Done                                             |
| US-20      | Envío de temperatura a través de un Edge Gateway       | T26              | Revisar conexión de IotProcess        | Probar la conexión y respuesta del endpoint Get para IotProcess                                 | 2                  | Sebastián      | Done                                             |
| US-17      | Registro de cliente                                    | T27              | Actualizar Profile al guardar cambios | Asegurar que los cambios en el perfil se reflejen al guardar y actualizar el backend            | 3                  | Camila         | Done                                             |
| US-18      | Registro de transportista                              | T28              | Validar datos en Put de Profile       | Implementar validaciones de datos en el servicio Put de Profile para evitar errores             | 3                  | Sebastián      | Done                                             |
| US-25      | Captura de Datos de Temperatura                        | T29              | Test de alarmas                       | Realizar pruebas de lógica de alarmas en distintas condiciones de temperatura                   | 4                  | Sebastián      | Done                                             |
| US-38      | Dashboard                                              | T30              | Diseñar Dashboard                     | Implementar un Dashboard  de datosen el frontent                                                | 2                  | Camila         | Done                                             |
| US-38      | Dashboard                                              | T31              | Diseñar Dashboard                     | Implementar un Dashboard  de datosen el frontent                                                | 2                  | Camila         | Done                                             |
| US-08      | Historial de servicios solicitados                     | T32              | Crear prueba de History               | Realizar pruebas en la sección de historial para verificar los datos del backend                | 3                  | Rodrigo        | Done                                             |
| US-18      | Registro de transportista                              | T33              | Test de conexión con Profile          | Realizar pruebas de conexión entre frontend y backend en la sección Profile                     | 3                  | Camila         | Done                                             |
| US-37      | Conectar Physical App con Backend                      | T34              | Test de conexión Physical App         | Probar la conexión de la Physical App al backend con el ESP32                                   | 4                  | Luis           | Done                                             |
| US-21      | Envío de datos de peso a través de un Edge Gateway     | T35              | Configuración inicial Embedded App    | Configurar la aplicación embedded para integración con el backend                               | 3                  | Rodrigo        | Done                                             |
| US-35      | Enviar alerta de peligro al transportista              | T36              | Ajuste de clases para alarmas         | Revisar y ajustar las clases en backend para manejar alarmas                                    | 3                  | Sebastián      | Done                                             |
| US-24      | Conexión de Sensor IoT a la Plataforma                 | T37              | Endpoint para alarmas                 | Crear un endpoint en el backend para manejar alarmas                                            | 4                  | Sebastián      | Done                                             |
| US-23      | Implementación de Edge Gateway con Backend Application | T38              | Implementar logs en Embedded App      | Añadir logs en la aplicación embedded para monitoreo                                            | 3                  | Rodrigo        | Done                                             |
| US-18      | Registro de transportista                              | T39              | Documentación de sección Profile      | Documentar la sección de Profile en el frontend                                                 | 2                  | Camila         | Done                                             |
| US-30      | Visualización de la información sobre el transporte    | T40              | Conexión de sensores con Dashboard    | Conectar los datos de sensores al dashboard                                                     | 4                  | Camila         | Done                                             |
| US-35      | Enviar alerta de peligro al transportista              | T41              | Alarmas con temperaturas altas        | Probar el funcionamiento de las alarmas en condiciones de temperatura elevada                   | 3                  | Sebastián      | Done                                             |
| US-36      | Configurar DHT22 y ESP32                               | T42              | Configuración avanzada de DHT22       | Configurar funciones avanzadas en el sensor DHT22                                               | 4                  | Luis           | Done                                             |
| US-18      | Registro de transportista                              | T43              | Test de endpoint Profile              | Probar el endpoint Profile para asegurar la integridad de los datos                             | 3                  | Camila         | Done                                             |
| US-37      | Conectar Physical App con Backend                      | T44              | Validación de datos en Physical App   | Implementar validación de datos antes de enviar a backend en la Physical App                    | 3                  | Luis           | Done                                             |
|            |                                                        | T45              | Despliegue del backend                | Despliegue del backend en el entorno de producción para la plataforma.                          | 5                  | Rodrigo Sabino | Done                                             |
|            |                                                        | T46              | Despliegue del frontend               | Despliegue del frontend en el entorno de producción para la plataforma.                         | 5                  | Rodrigo Sabino | Done                                             |
|            |                                                        | T47              | Despliegue de la aplicación móvil     | Despliegue de la aplicación móvil en el entorno de producción para la plataforma.               | 5                  | Rodrigo Sabino | Done                                             |
|            |                                                        | T48              | Despliegue del Landing Page           | Despliegue del landing page en el entorno de producción para la plataforma.                     | 3                  | Rodrigo Sabino | Done                                             |
